...
st.markdown(" you feel ready and confident in buying a new electric car. This decision, although not a simple one makes the most sense in the long run. After all, the numbers don't like, and you want all the pros that come along with it. Throughout this analysis we will explore the ins and outs of the electric car market and how it compares to the rest of the available vehicles out there. But, it with the addition of a little data science flair. We will look at:")

st.markdown("#### • The absolute wild inflation of fuel prices and how much its likely to increase.")
st.markdown("#### • The contrast to the cost of electricity over time and how much it would save someone.")
st.markdown("#### • Similiarly prices electric cars and gas powered cars to show contrast.")
