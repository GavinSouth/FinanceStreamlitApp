...
st.markdown(" > First of all, the cost of charging an electric car is variable. Gas prices are posted and change day to day, and outside the average cost there is little variation. This is not the case with the cost of electricity. Electricity prices for an EV will change depending on when and where you decide to charge it. For example there is a large difference between the cost of electricity in Hawaii compared to Idaho.  **That being said the cheapest way to charge an electric car is to install a home charging station and charge through the middle of night when power cost is the lowest.** That's ideal.")

st.markdown(" > The next thing to understand is the metric used to calculate the cost of operating an electric vehicle in regards to economy. When shopping for or considering a gasoline-powered car you will find the MPG it gets as the metric for overall distance the car can go on a gallon of fuel. You mention that you found the  metric and cost for your own can and understand the conversion and cost. In contrast, the metric used for electric cars in the same way is actually kilowatt-hours per 100 miles which is posted on all new electric cars right on their specifications. So, **to figure out your cost of charging at home, multiply your vehicle's kWh/100 miles figure by the electricity rate — the cost per kWh — for the time of day you'll most often be charging (more about that in a minute). That figure will tell you the cost per 100 miles.** There are obviously a lot more variation in the cost of electricity, but you can figure the cost the charge an EV just using averages like you did with the gasoline powered vehicles.")
